...
public final class PDPattern extends PDSpecialColorSpace
{
    ...
    public PDPattern(PDResources resources, PDColorSpace colorSpace)
    {
        ...
        array = new COSArray();
        array.add(COSName.PATTERN);
        array.add(colorSpace.getCOSObject());
    }
    ...
    {
        throw new UnsupportedOperationException("getNumberOfComponents is not supported in Android");
    }

    @Override
    public float[] getDefaultDecode(int bitsPerComponent)
    {
        throw new UnsupportedOperationException("getDefaultDecode is not supported in Android");
    }
    ...
    {
        throw new UnsupportedOperationException("toRGB is not supported in Android");
    }
     ...
     * @throws IOException if the pattern name was not found.
     */
